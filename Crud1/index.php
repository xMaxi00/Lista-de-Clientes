        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">Agregar Nuevo Cliente</h1> <!-- Titulo del Modal -->
                ...
                <div class="modal-body"> <!--Cuerpo del Formulario modal-->
                    ...
                    <br>
                    <p>Ingrese Dirección</p> <!-- Linea de Texto que solicita el titulo de la actividad a agregar-->
                ...
                <div class="modal-footer"> <!-- Botones de Cancelar y Guardar con sus caracteristicas -->
                    ...
                    <button type="submit" class="btn btn-dark" onclick= "validar()">Guardar</button>
                </div>
            </div>
        </div>
